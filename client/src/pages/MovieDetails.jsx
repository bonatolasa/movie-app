...
const MovieDetails = () => {
  ...
  return show ? (
    ...
    <p className='text-gray-400 max-w-xl mt-2 text-sm leading-tight'>{show.movie.overview}</p>
    ...
    <div className='flex items-center gap-4 w-max px-4'>
      {show.movie.casts.slice(0,12).map((cast,index) => (
        <div key={index} className='flex flex-col text-center items-center'>
          <img src={image_base_url + cast.profile_path} alt="" className='md:h-20 h-20 aspect-square object-cover rounded-full'/>
